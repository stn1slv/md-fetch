"""Integration tests for Boomi blog article extraction using real URLs."""
...
BOOMI_TEST_CASES: list[tuple[str, str]] = [
    (
        "https://boomi.com/blog/gartner-magic-quadrant-ipaas-2026/",
        "boomi-gartner-magic-quadrant-ipaas-2026.md",
    ),
    (
        "https://boomi.com/blog/real-time-vs-batch-data-integration-choosing-the-right-approach/",
        "boomi-real-time-vs-batch-data-integration.md",
    ),
    (
        "https://boomi.com/blog/how-to-maintain-data-consistency-across-saas-and-on-prem-systems/",
...
@pytest.mark.parametrize("url,snapshot", BOOMI_TEST_CASES)
...
def test_non_article_url_raises_unsupported_content_type_error() -> None:
    """US2: A boomi.com non-article URL (the blog index) raises UnsupportedContentTypeError."""
    with pytest.raises(UnsupportedContentTypeError):
        extract("https://boomi.com/blog/", retries=1, retry_delay=0.0)
